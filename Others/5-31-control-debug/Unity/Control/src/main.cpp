...
void loop(){
  ...
  while (i==0)
  {
    ...
    if(pinkcount + orangecount + redcount + bluecount + greencount < 50){ client.println("No Ball");}
    else if(pinkcount > orangecount && pinkcount*25 >redcount  && bluecount < pinkcount * 0.5){ client.println("Pink");}
    else if(orangecount > pinkcount && orangecount*15 > redcount && bluecount < orangecount * 0.5){ client.println("Orange");}
    else if(redcount >= bluecount && redcount >= pinkcount && redcount >= orangecount && redcount >= greencount && redcount>0 && bluecount < 25){client.println("Red");}
    else if (bluecount>25){client.println("Blue");}
    else if(greencount >= bluecount && greencount >= pinkcount && greencount >= orangecount && greencount >= redcount && greencount>0){client.println("Green");}
    else{
      client.println("No Ball Bottom for Loop");
    }
    connected = true;
