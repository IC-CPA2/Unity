...
#define MPU6050_SMPLRT_DIV_REGISTER   0x29
#define MPU6050_CONFIG_REGISTER       0x2a
#define MPU6050_GYRO_CONFIG_REGISTER  0x2b
#define MPU6050_ACCEL_CONFIG_REGISTER 0x2c
